 ...
 */
public class FrmRegistrarMate extends javax.swing.JDialog {
    private Curso mate;
    /**
     * Creates new form FrmRegistrarMate
     */
    public FrmRegistrarMate(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        String carrera = "Lic. Matematicas Aplicadas";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRegistrarMate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmRegistrarMate dialog = new FrmRegistrarMate(new javax.swing.JFrame(), true);
    ...
    public void agregar(){
        ...
        mate = new Curso(new Carrera(carrera),new Asignatura(materia),semestre);
    }
}
