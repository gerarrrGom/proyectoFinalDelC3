 ...
 * @author cardo
 */
public class FrmRegistrarZoo extends javax.swing.JDialog {
    private Curso zoo;
    /**
     * Creates new form FrmRegistrarZoo
     */
    public FrmRegistrarZoo(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        String carrera = "Lic. Zootecnia";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRegistrarZoo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmRegistrarZoo dialog = new FrmRegistrarZoo(new javax.swing.JFrame(), true);
    ...
    public void agregar(){
        ...
        zoo = new Curso(new Carrera(carrera),new Asignatura(materia),semestre);
    }
    public Curso get(){
        return zoo;
    }
