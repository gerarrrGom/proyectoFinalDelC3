...
public class FrmRegistrarMeca extends javax.swing.JDialog {
    private Curso meca;
    /**
     * Creates new form FrmRegistrarMeca
     */
    public FrmRegistrarMeca(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        String carrera = "Ing. Mecatronica";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRegistrarMeca.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmRegistrarMeca dialog = new FrmRegistrarMeca(new javax.swing.JFrame(), true);
    ...
    public void agregar(){
        ...
        meca = new Curso(new Carrera(carrera),new Asignatura(materia),semestre);
    }
    public Curso get(){
        return meca;
    }
