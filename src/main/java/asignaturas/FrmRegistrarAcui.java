 ...
 */
public class FrmRegistrarAcui extends javax.swing.JDialog {
    private Curso acui;
    /**
     * Creates new form FrmRegistrarAcui
     */
    public FrmRegistrarAcui(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        String carrera = "Ing. Acuicultura";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmRegistrarAcui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmRegistrarAcui dialog = new FrmRegistrarAcui(new javax.swing.JFrame(), true);
    ...
    public void agregar(){
        ...
        acui = new Curso(new Carrera(carrera),new Asignatura(materia),semestre);
    }
    public Curso get(){
        return acui;
    }
