...
public class FrmComputacion extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        tblComputacion.setBackground(new java.awt.Color(245, 245, 220));
        tblComputacion.setFont(new java.awt.Font("BodoniFLF", 1, 14)); // NOI18N
    ...
    private void btnAgregarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarMouseClicked
        FrmRegistrarCompu frmRegistrarCompu = new FrmRegistrarCompu(null, true);
        frmRegistrarCompu.setVisible(true);
        if ((modeloCompu.listaCursos() != null)) {
            modeloCompu.agregarCurso(frmRegistrarCompu.getCompu());
        }
    }//GEN-LAST:event_btnAgregarMouseClicked

    private void btnEditarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarMouseClicked
        ObjetosParaEditar.curs=modeloCompu.listaCursos().obtener(tblComputacion.getSelectedRow());
        FrmEditarCompu frm = new FrmEditarCompu(null,true);
        frm.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmComputacion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmComputacion dialog = new FrmComputacion(new javax.swing.JFrame(), true);
