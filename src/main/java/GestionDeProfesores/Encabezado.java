...
public class Encabezado extends PdfPageEventHelper {
    ...
    public void agregarEncabezado(PdfWriter writer) {
        ...
        try {
            ...
            //add image
            Image logo = Image.getInstance("C:\\Users\\Gerardo Fuentes\\Descargas\\LogoUnpa.jpg\\");
            ...
            text.addElement(new Phrase("GESTIÓN DE PROFESORES",f));
    ...
    public void agregarHeader(Document d) throws DocumentException {
        Image imagen;
        try {
            imagen = Image.getInstance("C:\\Users\\Gerardo Fuentes\\Descargas\\LogoUnpa.jpg\\");
        ...
        Paragraph texto=new Paragraph("Gestión de Profesores");
