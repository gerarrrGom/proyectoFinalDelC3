 ...
 * @author cardo
 */
public class FrmActividades2 extends javax.swing.JDialog {

    private ModeloActividades2 modelo;
    private BDActividades bd;
    private CursosImpartidos c;

    /**
     * Creates new form FrmActividades2
     */
    public FrmActividades2(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
         bd = new BDActividades();
        modelo = new ModeloActividades2();
    ...
    private void initComponents() {
        ...
        jPanel3.add(btnGuardarActividad, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 10, 90, 30));
    ...
    private void btnAgregarActividadMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAgregarActividadMouseClicked
        FrmAgregarActividades2 frmAgregarActividades2 = new FrmAgregarActividades2(null, true);
        frmAgregarActividades2.setVisible(true);
        modelo.agregarActividad(frmAgregarActividades2.getActiviad());
    ...
    private void btnEditarActividadMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnEditarActividadMouseClicked
        ...
        FrmEditarActividades2 frmEditarActividades2 = new FrmEditarActividades2(null,true);
        frmEditarActividades2.setVisible(true);
         modelo.editarActividad(modelo.listaActividades().obtener(tblActividad.getSelectedRow()),frmEditarActividades2.getActiviad());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmActividades2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmActividades2 dialog = new FrmActividades2(new javax.swing.JFrame(), true);
