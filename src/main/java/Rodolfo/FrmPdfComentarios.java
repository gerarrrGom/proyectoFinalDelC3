 ...
 */
public class FrmPdfComentarios extends javax.swing.JDialog {
        private Gestion g;
        BDComentarios bd;
    /**
     * Creates new form FrmPdf
     */
    public FrmPdfComentarios(java.awt.Frame parent, boolean modal) {
       super(parent, modal);
        initComponents();
        this.setLocationRelativeTo(this);
        bd=new BDComentarios();
...
public void abrirPdf(String nombre){
    ...
    private void exportar() {
        ...
        try {
            ...
            TablaPdfComentarios act = new TablaPdfComentarios();

            LinkedList<Comentario> lista = bd.obtener();
